...
if (isset($_SESSION['barcodes'])) {
    ...
    } else { utility::jsAlert(str_replace('{directory}', SB.FLS, __('ERROR! Barcodes failed to generate, possibly because {directory} directory is not writable')), utility::ALERT_TYPE_ERROR); }
    exit();
}
