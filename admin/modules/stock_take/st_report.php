...
<?php
    ...
    if (isset($_GET['print'])) {
        ...
        } else { utility::jsAlert(str_replace('{directory}', REPBS, __('ERROR! Current Stock Take Report failed to generate, possibly because {directory} directory is not writable')), utility::ALERT_TYPE_ERROR); }
        exit();
    } else {
        echo $report_content;
    }
