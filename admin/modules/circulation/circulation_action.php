...
if (isset($_POST['quickReturnID']) AND $_POST['quickReturnID']) {
    ...
    if ($loan_info_q->num_rows < 1) {
        ...
        $table->appendTableRow(array(str_replace(array('{itemCode}', '{returnDate}'), array($_POST['quickReturnID'], slims_date_format($return_date)), __('Item {itemCode} successfully returned on&nbsp;{returnDate}')))); //mfc
