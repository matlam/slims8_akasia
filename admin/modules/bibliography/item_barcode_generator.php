...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
  ...
  $html_str .= '</head>'."\n";
  $html_str .= '<body>'."\n";
  $html_str .= '<a class="printButton" href="#" onclick="window.print()">' . __('Print Again') . '</a>'."\n";
  ...
  } else { utility::jsAlert(str_replace('{directory}', SB.FLS, __('ERROR! Item barcodes failed to generate, possibly because {directory} directory is not writable')), utility::ALERT_TYPE_ERROR); }
  exit();
}
