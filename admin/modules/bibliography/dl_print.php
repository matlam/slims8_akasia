...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
    ...
    } else { utility::jsAlert(str_replace('{directory}', SB.FLS, __('ERROR! Label failed to generate, possibly because {directory} directory is not writable')), utility::ALERT_TYPE_ERROR); }
    exit();
}
