...
if (isset($_POST['saveData']) AND $can_read AND $can_write) {
  ...
  // check form validity
    if (empty($server_name) OR empty($server_uri)) {
      utility::jsAlert(__('Server Name And URI can\'t be empty'), utility::ALERT_TYPE_ERROR);
      exit();
    } else {
      ...
      if (isset($_POST['updateRecordID'])) {
        ...
        if ($update) {
            utility::jsAlert(__('Server Data Successfully Updated'), utility::ALERT_TYPE_SUCCESS);
        ...
        if ($sql_op->insert('mst_servers', $data)) {
            utility::jsAlert(__('New Server Data Successfully Saved'), utility::ALERT_TYPE_SUCCESS);
