...
if (isset($_POST['saveData']) AND $can_read AND $can_write) {
    ...
    if (empty($publisherName)) {
        utility::jsAlert(__('Publisher Name can\'t be empty'), utility::ALERT_TYPE_ERROR); //mfc
        exit();
    } else {
        ...
        if (isset($_POST['updateRecordID'])) {
            ...
            if ($update) {
                utility::jsAlert(__('Publisher Data Successfully Updated'), utility::ALERT_TYPE_SUCCESS);
            ...
            if ($insert) {
                utility::jsAlert(__('New Publisher Data Successfully Saved'), utility::ALERT_TYPE_SUCCESS);
