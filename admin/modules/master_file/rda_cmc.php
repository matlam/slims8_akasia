...
if (isset($_POST['saveData']) AND $can_read AND $can_write) {
    ...
    // check form validity
    if (empty($name)) {
        utility::jsAlert(__('Name can\'t be empty'), utility::ALERT_TYPE_ERROR);
        exit();
    } else {
        ...
        if (isset($_POST['updateRecordID'])) {
            ...
            if ($update) {
                utility::jsAlert(__('Data Successfully Updated'), utility::ALERT_TYPE_SUCCESS);
            ...
            if ($sql_op->insert('mst_'.$type.'_type', $data)) {
                utility::jsAlert(__('New Data Successfully Saved'), utility::ALERT_TYPE_SUCCESS);
