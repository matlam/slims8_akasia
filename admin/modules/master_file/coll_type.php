...
if (isset($_POST['saveData'])) {
    ...
    if (empty($collTypeName)) {
        utility::jsAlert(__('Collection type name can\'t be empty'), utility::ALERT_TYPE_ERROR);
        exit();
    } else {
        ...
        if (isset($_POST['updateRecordID'])) {
            ...
            if ($update) {
                utility::jsAlert(__('Colllection Type Data Successfully Updated'), utility::ALERT_TYPE_SUCCESS);
            ...
            if ($insert) {
                utility::jsAlert(__('New Colllection Type Data Successfully Saved'), utility::ALERT_TYPE_SUCCESS);
    ...
    if ($still_have_item) {
        ...
        utility::jsAlert(__('Below data can not be deleted:').$undeleted_coll_types, utility::ALERT_TYPE_ERROR);
        exit();
    }
    // error alerting
    if ($error_num == 0) {
