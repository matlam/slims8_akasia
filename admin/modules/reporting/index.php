...
if (isset($_GET['print'])) {
    ...
    } else { utility::jsAlert(str_replace('{directory}', REPBS, __('ERROR! Collection Statistic Report failed to generate, possibly because {directory} directory is not writable')), utility::ALERT_TYPE_ERROR); }
    exit();
}
