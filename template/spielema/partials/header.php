  ...
  <div class="row">
    <div class="col-lg-6">
      <a href="index.php" class="s-brand">
        <img class="s-logo animated flipInY delay7" src="<?php echo $sysconf['template']['dir']; ?>/spielema/img/non-gpl/spielema_logo_ohne_farbverlauf_sw_cropped_small_transparent_inverted.png" alt="<?php echo $sysconf['library_name']; ?>" />
